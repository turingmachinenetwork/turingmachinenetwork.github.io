...
function getWeb3ToReadDataForTuringData() {
    // const RPC_END_POINT = 'https://cronos-testnet-3.crypto.org:8545';
    const RPC_END_POINT = 'https://evm-cronos.crypto.org';
    // const RPC_END_POINT = 'https://rpc.vvs.finance';
    // const RPC_END_POINT = 'https://data-seed-prebsc-1-s1.binance.org:8545/'
    const MyWeb3 = new Web3(RPC_END_POINT);
    return MyWeb3;
}
...
function loadTuringData() {
    ...
    function _updateTuringData(_result) {
        ...
        turingData.price = parseFloatNumber(parseInt(_result.price_) / 1e6, 6);
        _drawUI();
    }
